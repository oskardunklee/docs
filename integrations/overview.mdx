...
Stanna integrates seamlessly with your existing tools to create a unified customer success platform. All interactions are automatically tracked, analyzed for sentiment, and used by Lars AI to provide intelligent insights.

<Frame caption="Integrations dashboard showing connected tools and sync status">
  <img src="/images/integrations-snippet.svg" alt="Integrations page showing Gmail and HubSpot connected, with Intercom available to connect" />
</Frame>
