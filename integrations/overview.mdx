...
<Info>
**Want to request an integration?** Email [integrations@stanna.io](mailto:integrations@stanna.io) with your specific needs and use case.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Technical Support" icon="wrench">
    Integration issues? Email [support@stanna.io](mailto:support@stanna.io) with integration name and error details
  </Card>
</CardGroup>